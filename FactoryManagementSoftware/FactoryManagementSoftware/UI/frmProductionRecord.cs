        ...
        private bool SaveSuccess()
        {
            ...
            if(Validation())
            {
                ...
                if(success)
                {
                    ...
                    {
                        //new sheet
                        tool.historyRecord(text.AddDailyJobSheet, text.Success, updateTime, userID);
                    }
                    else
                    {
                        //edit/modify sheet
                        tool.historyRecord(text.EditDailyJobSheet, text.Success, updateTime, userID);
                    }
