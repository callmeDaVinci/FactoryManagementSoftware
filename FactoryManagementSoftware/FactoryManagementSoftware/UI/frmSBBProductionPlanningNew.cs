...
{
    public partial class frmSBBProductionPlanningNew : Form
    {
        ...
        public frmSBBProductionPlanningNew()
        {
            InitializeComponent();
        ...
        public frmSBBProductionPlanningNew(string itemName, string itemCode)
        {
            InitializeComponent();
        ...
        public frmSBBProductionPlanningNew(int planID)
        {
            InitializeComponent();
