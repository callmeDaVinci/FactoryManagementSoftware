    ...
    public partial class frmSBBVer2 : Form
    {
            ...
            if(DT_STOCK_ALERT_MASTER_LIST != null)
            {
                ...
                foreach (DataRow row in FilteredTable.Rows)
                {
                    ...
                    if ((!cbOtherMaterial.Checked && (itemType == "98" || itemType == "97")) ||
                        (!cbPart.Checked && itemType != "97" && itemType != "98"))
                    {
                        toDelete.Add(row);
                    }
                }
        ...
        private void ToggleUIExpansion()
        {
            if (!STOCK_ALERT_IS_EXPANDED)
            {
                ...
                btnUIExpand.BackgroundImage = FactoryManagementSoftware.Properties.Resources.icons8_exit_full_screen_64;
            ...
            else
            {
                ...
                btnUIExpand.BackgroundImage = FactoryManagementSoftware.Properties.Resources.icons8_toggle_full_screen_50;
