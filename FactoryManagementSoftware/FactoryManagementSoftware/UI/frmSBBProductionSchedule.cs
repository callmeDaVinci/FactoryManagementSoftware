...
{
    public partial class frmSBBproductionSchedule : Form
    {
        public frmSBBproductionSchedule()
        {
            InitializeComponent();
            InitializeData();
        ...
        public frmSBBproductionSchedule(bool _fromDailyJobRecord)
        {
        ...
        private void dgvScheduleUIEdit(DataGridView dgv)
        {
            ...
            dgv.Columns[headerMachineName].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
            ...
            //dgv.Columns[headerMaterial].Visible = false;
            //dgv.Columns[headerMaterialBag].Visible = false;
            //dgv.Columns[headerColorMaterial].Visible = false;
            //dgv.Columns[headerRecycle].Visible = false;
            //dgv.Columns[headerColorMaterialQty].Visible = false;
            //dgv.Columns[headerNote].Visible = false;
            dgv.Columns[headerFactory].Visible = false;
            dgv.Columns[headerMachine].Visible = false;
            dgv.Columns[headerAbleProduceQty].Visible = false;
            //dgv.Columns[headerPartCycleTime].Visible = false;
        ...
        {
            txtFactory.Text = text.Factory_Semenyih;

            tool.loadSBBMacIDByFactoryToComboBox(cmbMachine, text.Factory_Semenyih);
        ...
        private void cmbMachine_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    {
            //        string test = cmbMachine.SelectedValue.ToString();
        ...
        private void lblMachineReset_Click(object sender, EventArgs e)
        {
            cmbMachine.SelectedIndex = -1;
        }
    }
