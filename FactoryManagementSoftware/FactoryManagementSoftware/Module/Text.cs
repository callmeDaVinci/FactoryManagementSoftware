...
H/P: 012 - 733 0617 Email: general@safetyplastics.com.my / Sales Dept.: sales@safetyplastics.com.my";
       ...
       // public string PO_Delivered { get; } = "D/O DELIVERED";
        ...
        public string Header_SystemReject { get; } = "System Reject";
        ...
        public string Header_Transfer_Qty { get; } = "Transfer Qty";
        ...
        public string Header_StockCount { get; } = "Stock Count (Full Packing)";
        public string Header_Qty_per_Packing { get; } = "Qty per Packing";
        public string Header_StdPacking_Info { get; } = "Std. Packing";
