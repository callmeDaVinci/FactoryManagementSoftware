...
namespace FactoryManagementSoftware.DAL
{
    class stockCountListItemDAL
    {
        ...
        public string DefaultOutTblCode { get; } = "default_out_tbl_code";
        public string DefaultInTblCode { get; } = "default_in_tbl_code";
        ...
        public bool Insert(stockCountListItemBLL u)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@default_out_tbl_code", u.default_out_tbl_code);
                cmd.Parameters.AddWithValue("@default_in_tbl_code", u.default_in_tbl_code);
            ...
            try
            {
                string sql = $@"UPDATE tbl_stock_count_list_item
                        SET 
                            ...
                            {DefaultOutTblCode} = @default_out_tbl_code, 
                            {DefaultInTblCode} = @default_in_tbl_code, 
            ...
            using (SqlConnection conn = new SqlConnection(myconnstrng))
            {
                ...
                BEGIN
                    CREATE TABLE tbl_stock_count_list_item(
                        ...
                        {DefaultOutTblCode} INT NOT NULL,
                        {DefaultInTblCode} INT NOT NULL,
