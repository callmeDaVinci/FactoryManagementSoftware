...
;
        ...
        public DataTable rangeMaterialInFromSupplierSearch(string start, string end, string Supplier)
        {
            //static methodd to connect database
            SqlConnection conn = new SqlConnection(myconnstrng);
            //to hold the data from database
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@end", end);
                cmd.Parameters.AddWithValue("@cat", cat);
                cmd.Parameters.AddWithValue("@from", Supplier);
        ...
        public DataTable rangeMaterialOutToCustomerSearch(string start, string end, string Customer)
        {
            //static methodd to connect database
            SqlConnection conn = new SqlConnection(myconnstrng);
            //to hold the data from database
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@end", end);
                cmd.Parameters.AddWithValue("@cat", cat);
                cmd.Parameters.AddWithValue("@to", Customer);
