...
namespace FactoryManagementSoftware.DAL
{
    class itemDAL
    {
        ...
        public bool Insert(itemBLL u)
        {
            ...
            try
            {
                String sql = "INSERT INTO tbl_item (item_code, item_name, item_added_date, item_added_by) VALUES (@item_code, @item_name, @item_added_date, @item_added_by)";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        public bool Update(itemBLL u)
        {
            ...
            try
            {
                String sql = "UPDATE tbl_item SET item_name=@item_name, item_updtd_date=@item_updtd_date, item_updtd_by=@item_updtd_by WHERE item_code=@item_code";
                SqlCommand cmd = new SqlCommand(sql, conn);
